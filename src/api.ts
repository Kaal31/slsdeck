...
export const tokeerEnsureProton = callable<[force?: boolean], { success: boolean; installed?: boolean; name?: string; path?: string; requiredProton?: string; error?: string }>("tokeer_ensure_proton");

...
export type TokeerVerifyResult = { success: boolean; code?: string; checks?: TokeerChecks | null; failedChecks?: string[]; report?: any; output?: string; returnCode?: number; needsPrepare?: boolean; error?: string };
...
export const archiveSnapshotGame = callable<[appid: number, launchOptions?: string | null, compatTool?: string, name?: string, buildid?: string], { success: boolean; fixes?: number; hasFixState?: boolean; dlcFiles?: number; error?: string }>("archive_snapshot_game");
...
export const crInstallStatus = callable<[], { success: boolean; installed: boolean; healthy?: boolean; appInstalled?: boolean; legacyFlatpakInstalled?: boolean; moonHookInstalled?: boolean; allHookLocationsValid?: boolean; partial?: boolean }>("cr_install_status");

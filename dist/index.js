...
function TokeerSection() {
    ...
    SP_REACT.useEffect(() => {
        ...
        if (activation && !codeReceivedAtRef.current)
            codeReceivedAtRef.current = Date.now();

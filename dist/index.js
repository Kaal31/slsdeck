...
function TokeerSection() {
    ...
    const cancelTicket = async () => {
        ...
        try {
            ...
            if (!r.success) {
                setMessage(r.error || "Could not press Discord's Cancel Ticket button.");
                return;
            }
            try {
                window.localStorage.removeItem(TOKEER_SESSION_KEY$1);
